...
\bea
    \langle \psi, \mathcal K_n \rangle_\mcH &= \frac 1 2 \int_{-1}^1 f'(x)(1+x)L_n(x) \d x + \frac{n^2 + n + 2} 2 \int_{-1}^1 f(x)L_n(x) \d x \\
...
and so
\bea
    \frac{| \langle \psi, \mathcal K_n \rangle_\mcH |}{\| \mathcal K_n \|_\mcH^2} \| K_n \|_\infty &\leq \left[  \frac {2 \| f' \|_\infty} {\sqrt{6n + 3}} + V_1\sqrt{2\pi} \frac{n^2 + n + 2}{\sqrt n (4n^2 + 1)} \right] \times \left[ \frac{2n + 1}{(n^2 + 1)((n+1)^2 +1)} \right] \times \left[ 2n^2 + 1\right] \\
